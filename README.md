...
Конструктор:  
 constructor(products: IProduct[] = [], selectedProduct: IProduct | null = null) — принимает параметры массив продуктов и выбранный продукт  

Методы класса:  
- `setProducts(items: IProduct[]): void` — сохранение в поле `products` массива товаров полученного в параметрах метода  
...
Конструктор:  
  constructor(basket: IProduct[] = []) — принимает массив с продуктами, находящимися в корзине  

Методы класса:  
- `getBasket(): IProduct[]` — возвращает массив товаров, которые находятся в корзине  
- `setProductItem(item: IProduct): void` — добавление товара в поле `basket`, который был получен в параметре в массив корзины  
- `deleteProductItem(id: string): void` — удаление товара, полученного в параметре из массива корзины  
...
Конструктор:  
  constructor(payment: TPayment = 'card', address: string = "", phone: string = "", email: string = "") — принимает тип оплаты и контактные данные, тип оплаты по умолчанию `card`  

Методы класса:  
- `set payment(value: TPayment): void` —  сохранение данных в поле `payment`  
- `set address(value: string): void` — сохранениие данных в поле `address`  
- `set phone(value: string): void` — сохранеине данных в поле `phone`  
- `set email(value: string): void` — сохранеине данных в поле `email`  
